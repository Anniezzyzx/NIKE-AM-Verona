(function () {
  ...
  var Banner = {
    init: function init() {
      ...
      var dom = domIds();
      var elements = ['#img-01', '#img-02', '#img-03', '#img-04'];
      var positions = ['first', 'second', 'third', 'fourth']; ////////////////////////////////////////////////////// ANIMATION //////////////////////////////////////////////////////
      ...
      function changePosition() {
        ...
        tlPhotos.add('frame1').call(changeElement, [elements[0], elements[1], elements[2], elements[3]], this, 'frame1').add('frame2', '+=' + duration).call(changeElement, [elements[1], elements[2], elements[3], elements[0]], this, 'frame2').add('frame3', '+=' + duration).call(changeElement, [elements[2], elements[3], elements[0], elements[1]], this, 'frame3').add('frame4', '+=' + duration).call(changeElement, [elements[3], elements[0], elements[1], elements[2]], this, 'frame3');
      }
