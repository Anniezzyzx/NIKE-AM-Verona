  ...
  var Banner = {
    init: function init() {
      ...
      function frame0() {
        ...
        tl.from('#img-01', 1, {
          scale: 1.2
        }, '+=0.5') //.staggerFrom (['#txt-01','#txt-01b','#txt-02'],0.01,{autoAlpha:0}, 0.1)
        .staggerFrom(['#txt-01', '#txt-01b', '#txt-02', '#txt-03', '#txt-04', '#air', '#logo,#airmax90'], 0.01, {
          autoAlpha: 0
        }, 0.1) //.to('#img-01',1,{scale:0.64, x:52, y:-54})
        .from('#cta', 0.5, {
          autoAlpha: 0
        }, '+=0.7');
      } ////////////////////////////////////////////////////// EVENT HANDLERS //////////////////////////////////////////////////////
